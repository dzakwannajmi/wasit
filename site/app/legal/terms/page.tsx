...
/**
 * Standalone legal page, same shape as app/why/page.tsx: no sidebar, no
 * table of contents, just the .typeset primitive. Content is written
 * directly here (not pulled from a repo doc) since it's specific to the
 * hosted site rather than the project's own documentation.
 */
