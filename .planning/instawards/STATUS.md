...
Last updated: 2026-09-06 (0.3.0 published, tagged and released; site and docs
settled on one name for the tool; published packages verified against source
with a real settlement run)
